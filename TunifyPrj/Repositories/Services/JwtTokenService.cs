...
namespace TunifyPrj.Repositories.Services
{
    public class JwtTokenService
    {
        ...
        public JwtTokenService(IConfiguration configuration , SignInManager<CustomUser> signInManager)
        {
        ...
        public async Task<string> GenerateToken(CustomUser user, TimeSpan expiryDate)
        {
